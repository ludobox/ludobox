        ...
        <div className="row" style={{paddingTop : '4em'}}>
          ...
          <div className="six columns" style={{ textAlign : 'center', 'paddingTop' : '2em'}}>
            ...
            <ul style={{ listStyle : 'none' }}>
              <li>
                <p>
                  Drop us a line at <a href="mailto:contact@ludobox.net">contact@ludobox.net</a>
                  <br />
                  or find somewhere else online
                </p>
              </li>
              <li>
                <a href="https://twitter.com/printcraftplay">
              ...
              <li>
                <a href="https://github.com/ludobox">
